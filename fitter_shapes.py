...
from logger_utils_fit import setup_logger, print_efficiency_summary, CustomTimeElapsedColumn, print_fit_summary_rich
    ...
    if mass == "Z" or mass == "Z_muon":
        SIGNAL_MODELS = {
            "dcb": {
                ...
                "bounds": {"mu": (85, 90.5, 92), "sigma": (1, 3, 6), "alphaL": (0, 1.0, 10), "nL": (0, 5.0, 30), "alphaR": (0, 1.0, 10), "nR": (0, 5.0, 30)},
            },
            "dv": {
                "pdf": double_voigtian,
                "cdf": None,
                "params": ["mu", "sigma1", "gamma1", "sigma2", "gamma2"],
                "bounds": {"mu": (85, 90, 93), "sigma1": (2.0, 3.0, 4.0), "gamma1": (0.01, 0.5, 3.0), "sigma2": (1.0, 2.0, 3.0), "gamma2": (0.01, 1.0, 3.0)},
            },
            ...
            "cbg": {
                ...
                "bounds": {"mu": (85, 90, 92), "sigma": (1, 3, 6), "alpha": (-10, -1, 10), "n": (0, 5.0, 30), "sigma2": (1, 3, 10)},
            },
        }
